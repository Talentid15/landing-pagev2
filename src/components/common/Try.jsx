...
const TryForFreePopup = ({ isOpen, onClose }) => {
      ...
      <div className="bg-white/90 rounded-2xl p-8 w-full max-w-md relative shadow-2xl transform transition-all duration-300 scale-100 hover:scale-102">
        ...
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            <Link to={"https://offers.talentid.app/login"} className="w-full px-6 py-4 bg-gradient-to-r from-[#652d96] to-[#8a4fc5] text-white rounded-xl hover:from-[#552480] hover:to-[#7a43b0] transition-all duration-300 flex items-center justify-center gap-3 shadow-md hover:shadow-lg">
              <User className="w-5 h-5" />
              <span className="font-medium">Sign up as Candidate</span>
            </Link>
            
            <Link to={"https://work.talentid.app/"} className="w-full px-6 py-4 bg-gradient-to-r from-[#652d96] to-[#8a4fc5] text-white rounded-xl hover:from-[#552480] hover:to-[#7a43b0] transition-all duration-300 flex items-center justify-center gap-3 shadow-md hover:shadow-lg">
